...
Implement a date class
    ...
    int day
    int year
    int hour //in miilitary time
    //dates will be represented as mm/dd/yyyy/hh

    public functions
    set(month_, day_, year_ hour_) mutator 
    overloaded == relational operator if two dates are the same
    overloaded < relational operator if d1 < d2 is true
    overloaded <= relational operator
    overloaded - operator and return difference in hours
    print() - print the date in format "Month dd, yyyy, hh:00" like March 12, 2103, 23:00
