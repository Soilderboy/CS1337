/*
So complex is a class with real and imaginary data members

form is real + imaginary * i

in essence this program does:

take user input for two complex numbers
adds them together using + and +=
outputs result
takes complex input using cin
dynamically allocate complex with new
~ to get conjugate (a conjugate is basically x+3 becomes x-3)
